 ...
 */
@AutoRegister
object SweepAttackFeature : AbstractFeature("sword") {
    override fun hook(node: EventNode<InstanceEvent>) {
        node.addListener(EntityAttackEvent::class.java) { event ->
            ...
            player.instance.getNearbyEntities(player.position, player.getAttrValue("SweepRange")?:return@addListener).forEach { entity ->
